...
# ╔═╡ a8df3175-318a-46fe-ad7b-4f0015bc929b
using CSV, DataFrames, Plots, PlotlyJS

# ╔═╡ 922a1350-af32-11ed-1e2b-eb1e26130d5e
md"# Análisis de datos"

# ╔═╡ 97ffb0ba-7ede-44bb-b1da-bb64d274aaec
md"Paquetes a utilizar"

# ╔═╡ 919dc9f8-41e1-4848-9308-79ba54e26771
plotlyjs()

# ╔═╡ 4cd6bc2c-f891-40d9-98d9-0d5838616a78
begin
	data = CSV.read("airports.csv", DataFrame)
end

# ╔═╡ 5e9c600b-f5d5-415a-bb85-1fac852a2485
begin
    ...
    println("$(data[p, 1]), a $o unidades")
	end
end

# ╔═╡ d0db6096-88b2-4a21-a26f-9a41bc07869f
dist("HOU")

# ╔═╡ e52d150f-cdd3-42ca-b6ac-403b8042df30
Plots.scatter(data[:, 7], data[:, 6])
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "d91f08c9614454f847e89f1b50731b573cdd3630"
